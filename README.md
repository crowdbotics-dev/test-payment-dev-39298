...
## Project Structure
    ...
    ├── test_payment_dev_39298  # Django project configurations
...
1. Clone this repo and `cd test_payment_dev_39298`
...
2. Clone this repo and `cd test_payment_dev_39298`
